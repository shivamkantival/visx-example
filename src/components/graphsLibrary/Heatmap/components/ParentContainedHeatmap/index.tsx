...
import { ParentContainedHeatmapProps } from '../../typeDefs';
...
const ParentContainedHeatmap: <BinDataType = any>(
  props: ParentContainedHeatmapProps<BinDataType>
...
export default ParentContainedHeatmap;
