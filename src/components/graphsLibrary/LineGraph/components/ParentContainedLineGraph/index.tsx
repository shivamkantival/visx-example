...
const ParentContainedLineGraph: (
  props: ParentContainedLineGraphProps
) => ReactElement<ParentContainedLineGraphProps> | null = ({
  uniqueKey,
  padding,
  data,
  width,
...
export default ParentContainedLineGraph;
